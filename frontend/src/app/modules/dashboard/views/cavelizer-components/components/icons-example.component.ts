...
@Component({
  ...
  template: `
    <mat-expansion-panel expanded="true">
      ...
      <select [(ngModel)]="iconColor" class="mb--32 ml--24">
      ...
      <div class="flex gap--30">
        <cavelizer-icon *ngFor="let icon of projectIcons" [name]="icon" [matTooltip]="icon"
                        [cdkCopyToClipboard]="copyToClipboard(icon)"
                        [ngClass]="[iconsSize, iconColor]"></cavelizer-icon>
      </div>
