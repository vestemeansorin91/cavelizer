  ...
  template: `<mat-expansion-panel expanded="true">
    ...
    <div class="flex flex--wrap gap--16 mb--16">
      ...
      <cvz-tag class="narrow"
        >Vegetables<cvz-icon name="close" class="very-small color-primary align--center ml--6"></cvz-icon
      ></cvz-tag>
    ...
    <div class="flex flex--wrap gap--16 mb--16">
      ...
      <cvz-tag class="disabled narrow "
        >Vegetables<cvz-icon name="close" class="very-small color-grey align--center ml--6"></cvz-icon
      ></cvz-tag>
