...
export const getCurrentUserSuccess = createAction(
  ...
  props<GetCurrentUserResponseInterface>()
);
...
/*    Avatar update   */
export const avatarUpload = createAction(ActionTypes.AVATAR_UPLOAD, props<{ file: File | null }>());
export const avatarUploadSuccess = createAction(ActionTypes.AVATAR_UPLOAD_SUCCESS, props<SignInResponseInterface>());
export const avatarUploadFailure = createAction(
  ActionTypes.AVATAR_UPLOAD_FAILURE,
  props<{ errors: ApiErrorsInterface }>()
);

/* TODO: Should be moved to own store (profile) */
/*    Avatar remove   */
export const avatarRemove = createAction(ActionTypes.AVATAR_REMOVE);
export const avatarRemoveSuccess = createAction(ActionTypes.AVATAR_REMOVE_SUCCESS, props<{ accessToken: string }>());
export const avatarRemoveFailure = createAction(
  ActionTypes.AVATAR_REMOVE_FAILURE,
  props<{ errors: ApiErrorsInterface }>()
);
