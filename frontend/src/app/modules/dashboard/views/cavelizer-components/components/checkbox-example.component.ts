  ...
  template: `
    <mat-expansion-panel>
      ...
      <div class="flex--column gap--16">
        ...
        <cavelizer-checkbox [(ngModel)]="disabledByDefault" [disabled]="true">This checkbox is disabled by default
        </cavelizer-checkbox>
        <cavelizer-checkbox [(ngModel)]="disabledByDefaultAndTrue" [disabled]="true">This checkbox is disabled by
          default and true
        </cavelizer-checkbox>
      </div>
    </mat-expansion-panel>`
